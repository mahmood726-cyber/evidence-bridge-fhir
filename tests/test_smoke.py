"""Import-smoke + pure-function tests for evidence-bridge-fhir (Bucket-B no-tests remediation).
...
_SCRIPT = os.path.join(
    ...
    'scripts', 'build_evidence_bridge_fhir.py')


def _load():
    sys.path.insert(0, os.path.dirname(_SCRIPT))
    spec = importlib.util.spec_from_file_location("buildmod_evidence_bridge_fhir", _SCRIPT)
